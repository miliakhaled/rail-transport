"""
This class is created to override the DjangoListObjectType from django_graphene_extra
The main goal is to replace django-extra registry with django_graphene global registry
"""
...
from graphene_django_extras.fields import DjangoObjectField, DjangoListObjectField
from graphene_django_extras.paginations.pagination import BaseDjangoGraphqlPagination
from graphene_django_extras.registry import get_global_registry, Registry
from graphene_django.registry import get_global_registry as global_registry, Registry as Registry2
...
class CustomDjangoListObjectType(ObjectType):
    ...
    def __init_subclass_with_meta__(
        ...
        **options,
        ...
        baseType = global_registry().get_type_for_model(model)
        #print(model, baseType2)
        if not baseType:
            factory_kwargs = {
                "model": model,
